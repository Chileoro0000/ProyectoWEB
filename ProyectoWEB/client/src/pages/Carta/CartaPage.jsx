      ...
      <div>
        ...
        <div className="ContainerOfertas">
          {Productos.map(eachProducto => {
            return (
              <div id="carta">
                <div className="imgProducto"> {(eachProducto.imagenURL)}</div>
                ...
                <div className="cardButton">
                  <svg className="svg-icon" viewBox="0 0 20 20">
                    ...
                    {/* <div className="card">
                        <div className="card-img">{(eachProducto.imagenURL)}</div>
                        <div className="card-info">
                          <p className="text-title">{eachProducto.nombre}</p>
                          <p className="text-body">{eachProducto.tipo}</p>
                        </div>
                        <div className="card-footer">
                        <span className="text-title">${eachProducto.precio}</span>
